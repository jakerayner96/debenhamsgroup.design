...
Read `.context/` before doing anything. Start with `00-readme.md`, then `16-session-log-2026-09-03b.md` for current PLP/DS state (11–15 are the earlier history) and `17-session-log-2026-09-08.md` for the Core PDP 2026 kick-off (lives in its own repo: github.com/jakerayner96/core-pdp-2026) + `19-session-log-2026-09-09.md` for its latest state (entry-point families 08/09, shuffle toggle, live footer), then `24-session-log-2026-09-15.md` for the latest PLT Social state (stories rail + toggle, Deliver+ PDP/bag banner re-cut per Best App Ever 465:22472, dock clearance on PDP/Bag) and `23-session-log-2026-09-10b.md` for the PLT Social prototype kick-off (own repo: github.com/jakerayner96/plt-social — TikTok-style feed, Glass/Flat chrome toggle, tab-bar layout options) and the page-level P-05 quick add, then `22-deliverplus-hero-set-2026-09-10.md` for the SEEL Deliver+ hero set (15 fascias, exact) and the design-vs-live discrepancy list awaiting Jake, then `21-session-log-2026-09-10.md` for the current site IA (Design system group, Foundations page, per-fascia component pages) and the 21-fascia token modes, then `20-session-log-2026-09-09b.md` for the front-end Storybook ingest, the component catalogue (`assets/ds/catalogue.js` → site Component library + wiki pages + our `storybook/`) and the dev-alignment plan, then `21-session-log-2026-09-10.md` for the Virtual Stylist re-cut of the VTO prototype (all seven fascias, own repo: github.com/jakerayner96/vto-prototype), then `23-session-log-2026-09-16.md` for the gift card email redesign (own repo: github.com/jakerayner96/debenhams-giftcard-email), then whichever doc matches the task.
...
Group-Design-System · colour-alignment-prototype · UX-Design-Request · checkout-2026-promo-gift-card · debenhams-giftcard-email · vto-prototype · plt-app-prototype (private) · debenhams-design-system-scraper (private)
